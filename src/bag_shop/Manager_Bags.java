...
public class Manager_Bags extends javax.swing.JFrame {

    /**
     * Creates new form Manager_Bags
     */
    public Manager_Bags() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Manage Cashiers");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bag", "Price", "Quantity", "Category"
            }
        ));
        jScrollPane1.setViewportView(table);
        if (table.getColumnModel().getColumnCount() > 0) {
            table.getColumnModel().getColumn(0).setHeaderValue("Bag");
            table.getColumnModel().getColumn(1).setHeaderValue("Price");
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        Cashier.searchBags(input, table);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manager_Bags.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manager_Bags().setVisible(true);
            }
        });
    }
